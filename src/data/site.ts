...
export const projects: Project[] = [
  ...
  },
  {
    ...
    cover: '/projects/school/cover.jpg',
    sheets: Array.from(
      { length: 32 },
      (_, i) => `/projects/school/board-${String(i + 1).padStart(2, '0')}.jpg`,
    ),
    pdf: '/projects/02_Kindergarten.pdf',
  },
  {
    id: 'prism',
    tab: 'edu',
    ...
    cover: '/projects/prism/cover.jpg',
    sheets: Array.from(
      { length: 36 },
      (_, i) => `/projects/prism/board-${String(i + 1).padStart(2, '0')}.jpg`,
    ),
    pdf: '/projects/03_High_Rise.pdf',
  },
  {
    id: 'kyosei',
    tab: 'edu',
